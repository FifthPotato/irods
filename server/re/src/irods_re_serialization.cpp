...
namespace irods::re_serialization
{
    ...
    static error serialize_ptr_to_vector_of_tuples_of_std_string_four_int64s_and_std_string(boost::any _p,
                                                                                 serialized_parameter_t& _out)
    {
        try {
            ...
            if (inp) {
                ...
                for (size_t i = 0; i < inp->size(); i++) {
                    ...
                    _out[std::to_string(i) + ":std_string_1"] = std::get<0>(tup);
                    ...
                    _out[std::to_string(i) + ":std_string_2"] = std::get<5>(tup);
                }
            }
            else {
