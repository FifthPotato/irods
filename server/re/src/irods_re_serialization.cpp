...
namespace irods::re_serialization
{
    ...
    static error serialize_ptr_to_vector_of_tuples_of_std_string_and_five_int64s(boost::any _p,
                                                                                 serialized_parameter_t& _out)
    {
        try {
            ...
            if (inp) {
                ...
                for (size_t i = 0; i < inp->size(); i++) {
                    ...
                    _out[std::to_string(i) + ":std_int64_5"] = std::get<5>(tup);
                }
            }
            else {
    ...
    serialization_map_t& get_serialization_map() {
        static serialization_map_t the_map{
            ...
            {std::type_index(typeid(irods::logical_quotas::quota_vector*)),
             serialize_ptr_to_vector_of_tuples_of_std_string_and_five_int64s}};
        return the_map;
